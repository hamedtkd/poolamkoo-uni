...
export default async function AccountPage() {
  ...
  return <div className="mx-auto max-w-3xl space-y-5">
    <header><div className="type-caption type-body-strong text-primary">حساب کاربری</div><h1 className="mt-1 type-page-title">هویت سروری، داده مالی محلی</h1><p className="mt-2 text-sm leading-7 text-muted-foreground">این حساب فقط برای ورود و جداسازی کاربران است. رکوردهای مالی روی IndexedDB همین مرورگر باقی می‌مانند.</p></header>
